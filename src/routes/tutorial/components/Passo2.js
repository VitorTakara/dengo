...
const Passo2 = () => (
    <Animated animationIn="fadeInRight" animationOut="fadeOut" isVisible={true}>
        ...
        <p>Ao Utilizar nosso chat, você terá suas dúvidas respondidas pelo nosso
            chocolatier ao vivo. Lembre-se de ativar o som do seu aparelho.</p>
        <p>Além disso, você pode selecionar os produtos direto da prateleira para obter
            mais informações e/ou adicioná-lo em seu carrinho de compras</p>
    </Animated>
);
