        ...
        ReactDOM.render(
            ...
            {this
                ...
                .map(item => {
                    return (
                        <div>
                            <img alt="imagem do produto" src={item}/>
                        </div>
                    );
                })}
        </Carousel>, document.getElementById("imagens"));
    }
        ...
        return (
            <aside className="p-relative sidebar-container">
                ...
                <div className="text-center">
                    <Counter></Counter>
                    <p className="sidebar-price">R$ {this
                            .props
                            .produto
                            .Preco
                    ...
                    <button
                        ...
                        onClick={() => {
                        this.props.produto.Quantidade = Number(document.querySelector("#counterValue").textContent);
                        this
                            .props
                            .addToCart(this.props.produto, true)
